...
uint8_t PerlinNoise::defaultPermutation[512] = {151, 160, 137, 91, 90, 15,
...
{
	uint8_t	X = static_cast<uint8_t>(std::floor(x)) & 255,
		    Y = static_cast<uint8_t>(std::floor(y)) & 255,
			Z = static_cast<uint8_t>(std::floor(z)) & 255;
